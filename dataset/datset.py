...
# ----------------------------
# Predator Behavioral Profiles
# ----------------------------

related_categories = {
    "toxicity": ["toxicity", "bullying"],
    "bullying": ["bullying", "toxicity"],

    "grooming": ["grooming", "coercion", "sexual"],
    "sexual": ["sexual", "grooming"],
    "coercion": ["coercion", "grooming", "sextortion"],
    "sextortion": ["sextortion", "coercion", "grooming"],

    "threat": ["threat", "toxicity"],
...
# Assign ONE dominant category to each predator
predator_profile = {}

all_categories = list(categories.keys())

for predator in predator_ids:
    predator_profile[predator] = random.choice(all_categories)
...
for i in range(total_samples):
    ...
    dominant_category = predator_profile[sender_id]

    r = random.random()

    # 70% dominant behavior
    if r < 0.70:
